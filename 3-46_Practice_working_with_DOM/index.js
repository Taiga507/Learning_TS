...
forms.forEach(function (form) { return form.addEventListener('submit', function (e) {
    var _a, _b, _c, _d;
    e.preventDefault();
    ...
    formData.checkbox = (_d = checkbox === null || checkbox === void 0 ? void 0 : checkbox.checked) !== null && _d !== void 0 ? _d : '';
